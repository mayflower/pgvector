...
- On the 100k GloVe ANN subset, `tq_exact_storage = off` produces a 23.664 MiB
  index versus 71.031 MiB for HNSW, but recall@10 drops from 0.8468 for HNSW to
  0.7304. The fixed low-dimensional approximate build path builds the
  TurboQuant variants in about 70-79 s on this subset, versus about 16.7 s for
  HNSW.
